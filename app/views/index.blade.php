...
<div class="loading" ng-if="!weather">
  {{ $loading }}<br><br>
  <img src="/assets/img/ajax.gif">
</div>
<div ng-if="weather">
<div class="container">    
  <span class="description">{[{ride_text}]}</span><br>
  <div class="temp">

    <span title="{[{weather.weather_detailed}]}" class="weather climacon {[{weather.weather}]}"></span><span class="temperature" style="color:#3d3d3d">{[{weather.temperature}]}</span><span class="format"  style="color:#3d3d3d">°C<br></span><span style="font-size:16px; color:#3d3d3d; text-align:center;">RIDE SAFE!</span></span>
  </div>
</div>

<div class="container">
<div class="location{[{activate}]}">
    <div class="inner">
        <div class="finder">
          <i ng-click="activeLocate()"></i>
          {[{weather.location}]}
        </div>
      <div class="teleporter">
          <input ng-change="change()" ng-model="$parent.location" type="text" placeholder="Change location...">
          <ul>
              <li ng-click="teleport(location.lat, location.lon)" ng-repeat="location in locations">
...
<!DOCTYPE svg PUBLIC "-//W3C//DTD SVG 1.1//EN" "http://www.w3.org/Graphics/SVG/1.1/DTD/svg11.dtd">
<svg version="1.1" id="Layer_1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px"
   viewBox="-64.5 -370.9 600.3 841.9" enable-background="new -64.5 -370.9 600.3 841.9" xml:space="preserve">
<g id="clouds">
  <g>
    <g id="XMLID_394_">
  ...
  <g id="XMLID_31_">
    ...
    <rect id="XMLID_32_" x="1081.4" y="-86" fill="#FFFFFF" width="30.6" height="14.2"/>
        ...
        <svg class="snap" xmlns="http://www.w3.org/2000/svg" width="400" height="30" viewBox="0 0 400 30">
          <g fill="none">
            <path stroke="#fff" class="roadPath" d="M400 20 l-600 0"/>
          </g>
          <g fill="none">
            <path stroke="#fff" class="hillPath" d="M484 20 l-1042 0"/>
          </g>
          <g fill="none">
            <path stroke="#fff" class="buildingPath" d="M550 20 l-1100 0"/>
          </g>
          <g fill="none">
